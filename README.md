...
| `lgwks_bot` | 0.2.1 | Async + actor roles: Observe, Evaluate, Execute, Query verbs over capability-gated domains |
...
| `lgwks_deps` | 0.1.4 | All other deps: admission, audit, freshness (`lgwks-deps check`) |
